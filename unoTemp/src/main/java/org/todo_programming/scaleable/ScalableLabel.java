...
public class ScalableLabel extends JLabel implements ComponentListener
{
	...
	private static String DEFAULT_FONT_NAME = "TimesRoman";					//Default font name
	private static int DEFAULT_FONT_STYLE = Font.BOLD;						//Default font style
	private static int DEFAULT_FONT_SIZE = 16;                              //Default font size
